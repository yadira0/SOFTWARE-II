        ...
        if ($numrows>0){
            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                ?>
                    ...
                    <input type="hidden" value="<?php echo $name;?>" id="objetivo<?php echo $id;?>">
                    <input type="hidden" value="<?php echo $objetivo;?>" id="name<?php echo $id;?>">
                    <input type="hidden" value="<?php echo $alcance;?>" id="alcance<?php echo $id;?>">
                    <input type="hidden" value="<?php echo $modalidad;?>" id="modalidad<?php echo $id;?>">
